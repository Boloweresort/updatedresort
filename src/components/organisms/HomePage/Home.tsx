...
import Amazon  from "../../../assets/new_images/landingImage.jpg"

// Import package images from the Package Images folder
// Note: Webpack handles spaces in folder names
...
// Local images for packages - three images from the Package Images folder
const packageImages = [
  regularFee,
  silverOnePerson,
  goldOnePerson,
...
// Static package data to always display with local images
const staticPackages = [
  { _id: '1', name: 'Regular Fee', image: regularFee },
  { _id: '2', name: 'Silver Package - One Person', image: silverOnePerson },
  { _id: '3', name: 'Gold Package - One Person', image: goldOnePerson },
];
      ...
      <section className="px-16 sm:px-4  sm:py-5 flex flex-col items-center">
       ...
       <Fade left duration={1000}>
        ...
        <div className="flex flex-wrap w-full  gap-x-6 gap-y-6 my-0 mb-10 flex-col minMd:flex-row minMd:justify-center">
          {staticPackages.map((pack: any, index: number) => (
              ...
              >
                ...
                <div className='absolute  bg-transparent group-hover:bg-black/20 rounded-sm hidden z-30 group-hover:flex transition-colors duration-1000  items-end justify-center w-full top-0 h-full'>
                  <a 
                    ...
                    className="bg-[#1AACAC] text-white px-20 my-6 rounded-lg py-4 border-solid border-[1px] border-[#1AACAC] font-bold no-underline"
                  >
                    Buy ticket
                  </a>
                </div>
        ...
        <Fade bottom duration={1000} delay={400}>
          <button 
            ...
            className="mt-8 px-16 py-4 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 transition-colors duration-300"
          >
            More
          </button>
        </Fade>
